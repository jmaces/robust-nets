...
def _get_gs_param(noise_rel):
    ...
    rho = 1e-1 if noise_rel > 16e-4 else 5.62341325e-04  # manual gs override
...
_append_net(
    ...
    _load_net(
        "results/Fourier_UNet_ee_jitter_v4_train_phase_2/model_weights.pt",
        UNet,
        unet_params,
        {
            "num_iter": 1,
...
_append_net(
    ...
    _load_net(
        "results/Fourier_UNet_it_jitter_v4_train_phase_2/"
        + "model_weights_epoch6.pt",
        UNet,
        unet_params,
        {
            "num_iter": 8,
...
_append_net(
    ...
    _load_net(
        "results/Fourier_Tiramisu_jitter_v3_train_phase_2/model_weights.pt",
        Tiramisu,
        tiramisu_params,
        {
            "num_iter": 1,
...
_append_net(
    ...
    _load_net(
        "results/Fourier_Tiramisu_ee_jitter_v7_train_phase_2/"
        + "model_weights_epoch7.pt",
        Tiramisu,
        tiramisu_params,
        {
            "num_iter": 1,
