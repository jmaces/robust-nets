...
class Args(argparse.ArgumentParser):
    ...
    def __init__(self, **overrides):
        """
        Args:
            **overrides (dict, optional): Keyword arguments used to override
        ...
        self.add_argument(
            ...
            default=384,
            type=int,
            help="Resolution of images (brain challenge expects resolution of "
            "384, knee resolution expcts resolution of 320)",
        )
        ...
        self.add_argument(
            "--data-path", type=pathlib.Path, help="Path to the dataset"
        )
        self.add_argument(
            "--sample-rate",
            type=float,
